...
@SourceType(value = "XMLARP", label = "XML",uiConfig = "xml-layout.json")
public class XMLConf extends AbstractArpConf<XMLConf> {
  private static final String ARP_FILENAME = "arp/implementation/xml-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.xml.XMLDriver";
